...
| Command | Description |
| --- | --- |
| !search_playerPN | Will show an embed message with lifetime stats and make a prediction about player's profile based on his stats. Player name is **REQUIRED**. |
