...
def profile(player_name, game):
    ...
    # -------- validating the correct player from the list recieved and getting ranking position for player's country --------#
    ranking = faceit_data.player_ranking_of_game(game, info_stats['games'][f'{game}']['region'], idPlayer,
                                                 info_stats['country'])
    counter2 = 0
    index_valid2 = 0
    ...
    # -------- getting game stats and processing it (replacing 0 with X emoji and 1 with white check mark),(replacing numbers from elo with number emoji's)--------#
    ...
    # -------- getting general data from player's account --------#
